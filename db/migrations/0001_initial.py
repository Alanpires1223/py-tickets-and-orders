# Generated by Django 4.0.2 on 2025-09-01 12:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='db_user_groups', related_query_name='db_user', to='auth.Group')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='db_user_permissions', related_query_name='db_user', to='auth.Permission')),
            ],
            options={
                'verbose_name': 'user',
